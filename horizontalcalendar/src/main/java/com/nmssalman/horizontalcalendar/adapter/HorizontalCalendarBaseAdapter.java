package com.nmssalman.horizontalcalendar.adapter;
...
import com.nmssalman.horizontalcalendar.HorizontalCalendarView;
import com.nmssalman.horizontalcalendar.HorizontalLayoutManager;
...
public abstract class HorizontalCalendarBaseAdapter<VH extends DateViewHolder, T extends Calendar> extends RecyclerView.Adapter<VH> {
    ...
    public abstract void onBindViewHolder(DateViewHolder holder, int position);

    public abstract void onBindViewHolder(DateViewHolder holder, int position, List<Object> payloads);
